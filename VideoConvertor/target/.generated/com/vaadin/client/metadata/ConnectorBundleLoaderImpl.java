...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.GridLayout","com.vaadin.ui.TreeTable","com.vaadin.ui.OptionGroup","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.NativeButton","com.vaadin.ui.JavaScript","com.vaadin.ui.Embedded","com.vaadin.ui.CssLayout","com.vaadin.ui.Window","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.MenuBar","com.vaadin.ui.NativeSelect","com.vaadin.ui.DateField","com.vaadin.ui.BrowserFrame","com.vaadin.ui.TabSheet","com.vaadin.ui.FormLayout","com.vaadin.ui.VerticalLayout","com.vaadin.ui.ProgressBar","com.vaadin.ui.PopupView","com.vaadin.ui.ListSelect","com.vaadin.ui.Accordion","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.Flash","com.vaadin.ui.TextField","com.vaadin.ui.Slider","com.vaadin.ui.Label","com.vaadin.ui.Image","com.vaadin.ui.CustomComponent","com.vaadin.server.FileDownloader","com.vaadin.ui.CustomLayout","com.vaadin.ui.CustomField","com.vaadin.ui.Link","com.vaadin.ui.Table","com.vaadin.ui.UI","com.wcs.wcslib.vaadin.widget.multifileupload.component.CustomUpload","com.vaadin.ui.PasswordField","com.vaadin.ui.InlineDateField","com.vaadin.ui.Tree","com.vaadin.ui.Form","com.vaadin.ui.Video","com.vaadin.ui.TwinColSelect","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.Panel","com.vaadin.ui.Audio","com.wcs.wcslib.vaadin.widget.multifileupload.component.MultiUpload","com.vaadin.ui.Button","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.CheckBox","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.TextArea","com.vaadin.ui.ComboBox","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Upload",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"tabIndex", "registeredEventListeners", "primaryStyleName", "hideErrors", "width", "description", "resources", "required", "height", "enabled", "id", "modified", "errorMessage", "styles", "immediate", "caption", "readOnly", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"readOnly", "width", "id", "enabled", "errorMessage", "registeredEventListeners", "immediate", "styles", "caption", "height", "primaryStyleName", "resources", "description", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"registeredEventListeners", "immediate", "enabled", "caption", "id", "primaryStyleName", "styles", "readOnly", "description", "resources", "height", "width", "alternateText", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"propertyReadOnly", "width", "hideErrors", "tabIndex", "id", "styles", "required", "registeredEventListeners", "descriptionForAssistiveDevices", "rangeStart", "enabled", "readOnly", "immediate", "primaryStyleName", "description", "height", "errorMessage", "modified", "caption", "resources", "rangeEnd", "textFieldEnabled", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"errorMessage", "width", "immediate", "splitterState", "caption", "firstChild", "primaryStyleName", "readOnly", "height", "description", "id", "registeredEventListeners", "styles", "secondChild", "enabled", "resources", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"registeredEventListeners", "errorMessage", "immediate", "height", "readOnly", "resources", "width", "description", "hideErrors", "required", "styles", "primaryStyleName", "id", "caption", "propertyReadOnly", "tabIndex", "enabled", "modified", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"childData", "registeredEventListeners", "styles", "spacing", "primaryStyleName", "immediate", "caption", "id", "resources", "height", "description", "enabled", "marginsBitmask", "readOnly", "width", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"caption", "height", "styles", "registeredEventListeners", "readOnly", "columns", "enabled", "width", "errorMessage", "rows", "resources", "id", "marginsBitmask", "childData", "description", "primaryStyleName", "immediate", "spacing", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"registeredEventListeners", "names", "resources", "enabled", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"immediate", "registeredEventListeners", "id", "errorMessage", "hideErrors", "primaryStyleName", "required", "description", "enabled", "tabIndex", "width", "height", "modified", "caption", "styles", "propertyReadOnly", "resources", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"resources", "hideErrors", "propertyReadOnly", "enabled", "width", "immediate", "description", "height", "styles", "id", "caption", "registeredEventListeners", "readOnly", "modified", "primaryStyleName", "errorMessage", "required", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row1", "column2", "column1", "row2", "alignment", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"description", "immediate", "styles", "modified", "hideErrors", "required", "height", "enabled", "registeredEventListeners", "errorMessage", "propertyReadOnly", "id", "readOnly", "primaryStyleName", "caption", "resources", "tabIndex", "width", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"enabled", "resources", "readOnly", "registeredEventListeners", "id", "templateContents", "errorMessage", "immediate", "primaryStyleName", "caption", "width", "templateName", "styles", "childLocations", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"id", "muted", "altText", "enabled", "primaryStyleName", "showControls", "autoplay", "description", "registeredEventListeners", "height", "sources", "resources", "sourceTypes", "readOnly", "htmlContentAllowed", "width", "caption", "styles", "errorMessage", "immediate", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"width", "resources", "description", "immediate", "errorMessage", "caption", "readOnly", "height", "styles", "primaryStyleName", "registeredEventListeners", "enabled", "childCss", "id", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"width", "caption", "readOnly", "target", "parameters", "errorMessage", "enabled", "height", "resources", "id", "primaryStyleName", "registeredEventListeners", "description", "uriFragment", "features", "styles", "immediate", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"registeredEventListeners", "callbackNames", "enabled", "resources", "rpcInterfaces", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"id", "required", "errorMessage", "description", "height", "propertyReadOnly", "resources", "registeredEventListeners", "readOnly", "columns", "inputPrompt", "primaryStyleName", "enabled", "text", "tabIndex", "width", "caption", "wordwrap", "hideErrors", "maxLength", "rows", "modified", "styles", "immediate", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"width", "hideErrors", "readOnly", "description", "propertyReadOnly", "primaryStyleName", "modified", "registeredEventListeners", "resources", "tabIndex", "required", "height", "errorMessage", "id", "caption", "immediate", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"errorMessage", "height", "description", "registeredEventListeners", "width", "readOnly", "primaryStyleName", "resources", "id", "styles", "immediate", "enabled", "caption", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"primaryStyleName", "state", "enabled", "hideErrors", "required", "id", "propertyReadOnly", "tabIndex", "description", "registeredEventListeners", "indeterminate", "resources", "styles", "width", "errorMessage", "height", "modified", "caption", "immediate", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"height", "errorMessage", "caption", "readOnly", "alternateText", "id", "primaryStyleName", "registeredEventListeners", "description", "resources", "immediate", "enabled", "styles", "width", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"caption", "id", "description", "primaryStyleName", "errorMessage", "modified", "tabIndex", "height", "enabled", "hideErrors", "propertyReadOnly", "styles", "immediate", "required", "columns", "registeredEventListeners", "readOnly", "text", "width", "resources", "inputPrompt", "maxLength", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"resources", "registeredEventListeners", "errorMessage", "modified", "primaryStyleName", "hideErrors", "required", "caption", "indeterminate", "propertyReadOnly", "immediate", "description", "styles", "pollingInterval", "id", "state", "width", "enabled", "readOnly", "height", "tabIndex", });
            ...
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"id", "styles", "readOnly", "description", "resources", "errorMessage", "immediate", "primaryStyleName", "width", "enabled", "height", "caption", "registeredEventListeners", });
            ...
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"description", "height", "errorMessage", "width", "alternateText", "registeredEventListeners", "enabled", "resources", "caption", "primaryStyleName", "styles", "readOnly", "immediate", "id", });
            ...
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionReversed", "maxPosition", "positionUnit", "locked", "minPosition", "minPositionUnit", "maxPositionUnit", "position", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"height", "description", "immediate", "enabled", "caption", "muted", "sources", "errorMessage", "width", "resources", "altText", "id", "htmlContentAllowed", "autoplay", "primaryStyleName", "registeredEventListeners", "styles", "readOnly", "showControls", "sourceTypes", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"errorMessage", "enabled", "immediate", "id", "primaryStyleName", "contentMode", "styles", "registeredEventListeners", "readOnly", "text", "width", "description", "height", "caption", "resources", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"propertyReadOnly", "registeredEventListeners", "id", "width", "required", "modified", "checked", "tabIndex", "enabled", "styles", "caption", "immediate", "readOnly", "hideErrors", "description", "resources", "height", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"styles", "secondChild", "errorMessage", "splitterState", "description", "firstChild", "height", "primaryStyleName", "id", "enabled", "immediate", "caption", "registeredEventListeners", "resources", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"width", "caption", "errorMessage", "htmlContentAllowed", "styles", "registeredEventListeners", "clickShortcutKeyCode", "primaryStyleName", "description", "height", "id", "iconAltText", "readOnly", "disableOnClick", "tabIndex", "enabled", "resources", "immediate", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"required", "modified", "immediate", "primaryStyleName", "width", "description", "registeredEventListeners", "propertyReadOnly", "readOnly", "caption", "resources", "errorMessage", "height", "enabled", "hideErrors", "styles", "id", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"primaryStyleName", "modified", "immediate", "resources", "required", "registeredEventListeners", "footer", "width", "layout", "propertyReadOnly", "tabIndex", "styles", "readOnly", "enabled", "caption", "description", "hideErrors", "id", "height", "errorMessage", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"shiftKey", "button", "altKey", "metaKey", "ctrlKey", "clientY", "relativeY", "type", "clientX", "relativeX", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"caption", "tabIndex", "rangeStart", "propertyReadOnly", "required", "height", "hideErrors", "modified", "id", "rangeEnd", "errorMessage", "immediate", "enabled", "primaryStyleName", "styles", "width", "readOnly", "registeredEventListeners", "resources", "description", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"enabled", "resources", "readOnly", "classId", "standby", "codebase", "description", "alternateText", "primaryStyleName", "id", "registeredEventListeners", "codetype", "embedParams", "caption", "height", "archive", "errorMessage", "width", "immediate", "styles", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"immediate", "height", "htmlContentAllowed", "id", "iconAltText", "caption", "styles", "disableOnClick", "clickShortcutKeyCode", "readOnly", "primaryStyleName", "errorMessage", "description", "registeredEventListeners", "tabIndex", "enabled", "resources", "width", });
            store.setProperties(java.util.Date.class, new String[] {"time", "minutes", "seconds", "date", "year", "month", "hours", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"rpcInterfaces", "immediate", "registeredEventListeners", "enabled", "errorMessage", "readOnly", "width", "id", "styles", "height", "callbackNames", "caption", "resources", "primaryStyleName", "description", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"quickOpenDelay", "quickOpenTimeout", "openDelay", "maxWidth", "closeTimeout", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"primaryStyleName", "caption", "positionX", "readOnly", "draggable", "positionY", "scrollTop", "resizeLazy", "width", "resources", "description", "id", "modal", "tabIndex", "styles", "resizable", "enabled", "scrollLeft", "windowMode", "immediate", "centered", "height", "registeredEventListeners", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"shortDayNames", "dayNames", "dateFormat", "pm", "am", "firstDayOfWeek", "monthNames", "twelveHourClock", "hourMinuteDelimiter", "name", "shortMonthNames", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"tabIndex", "description", "immediate", "scrollTop", "registeredEventListeners", "width", "resources", "height", "readOnly", "enabled", "scrollLeft", "styles", "id", "caption", "errorMessage", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"enabled", "width", "styles", "marginsBitmask", "primaryStyleName", "spacing", "errorMessage", "immediate", "id", "readOnly", "childData", "height", "resources", "description", "caption", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"mode", "parameters", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"primaryStyleName", "errorMessage", "caption", "height", "styles", "description", "hideOnMouseOut", "readOnly", "immediate", "enabled", "registeredEventListeners", "html", "resources", "width", "id", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"loadingIndicatorConfiguration", "errorMessage", "description", "pageState", "width", "immediate", "primaryStyleName", "readOnly", "id", "pushConfiguration", "caption", "height", "pollInterval", "styles", "tooltipConfiguration", "localeServiceState", "tabIndex", "registeredEventListeners", "overlayContainerLabel", "resources", "enabled", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"connectorToCssPosition", "immediate", "description", "id", "styles", "width", "resources", "readOnly", "errorMessage", "primaryStyleName", "caption", "registeredEventListeners", "enabled", "height", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"enabled", "spacing", "resources", "caption", "errorMessage", "primaryStyleName", "id", "childData", "registeredEventListeners", "styles", "immediate", "height", "marginsBitmask", "width", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"enabled", "tabIndex", "resources", "description", "value", "maxValue", "width", "primaryStyleName", "minValue", "height", "caption", "orientation", "immediate", "readOnly", "required", "resolution", "hideErrors", "modified", "errorMessage", "styles", "id", "registeredEventListeners", "propertyReadOnly", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"errorMessage", "styles", "description", "enabled", "immediate", "readOnly", "primaryStyleName", "tabIndex", "resources", "height", "caption", "registeredEventListeners", "id", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"description", "styleName", "index", "caption", "dateTo", "allDay", "timeTo", "timeFrom", "dateFrom", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"width", "format24H", "height", "days", "events", "primaryStyleName", "firstDayOfWeek", "firstHourOfDay", "firstVisibleDayOfWeek", "scroll", "caption", "registeredEventListeners", "lastVisibleDayOfWeek", "monthNames", "id", "now", "immediate", "actions", "styles", "dayNames", "enabled", "errorMessage", "resources", "description", "lastHourOfDay", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"startDate", "endDate", "iconKey", "actionKey", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"height", "width", "caption", "primaryStyleName", "description", "styles", "readOnly", "resources", "bgColor", "immediate", "cursorY", "cursorX", "enabled", "id", "registeredEventListeners", "errorMessage", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"immediate", "enabled", "height", "showDefaultCaption", "resources", "registeredEventListeners", "errorMessage", "width", "color", "caption", "id", "popupVisible", "description", "styles", "primaryStyleName", "readOnly", "htmlContentAllowed", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"primaryStyleName", "resources", "description", "registeredEventListeners", "id", "enabled", "changedColor", "errorMessage", "caption", "readOnly", "immediate", "styles", "width", "height", "rowCount", "changedY", "changedX", "columnCount", });
